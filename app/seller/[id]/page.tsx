...
import { useSellerDetailQuery } from "@/app/buyer/store/buyerSellersAPI";
import type {
  BuyerBestProvider,
...
function Divider() {
  return (
    <div style={{ height: "1px", background: "#EAECF0", margin: "28px 0" }} />
  );
}
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ${formatMoney(favor.startingPrice)}
          </span>
        </div>
        <div
          style={{
        ...
        >
            ...
            {badge ? (
              <span
                style={{
                  ...
                  fontSize: "11px",
                  fontWeight: 700,
                  background: badge === "Pro" ? "#A54AFF" : "#344054",
                  color: "#ffffff",
                  borderRadius: "9999px",
                  padding: "2px 8px",
                  flexShrink: 0,
          ...
          >
            ...
            >
              {(favor.totalReviews ?? 0).toLocaleString()}
            </span>
          </div>
        </div>
      </div>
...
export default function SellerProfilePage() {
  ...
  const { data, isLoading, isError } = useSellerDetailQuery(sellerId, {
    skip,
  });
  ...
  const ratingValue =
    seller?.averageRating != null ? Number(seller.averageRating) : 0;
  const ratingLabel = formatRating(seller?.averageRating);
  const distance = seller
    ? formatDistance(seller.distanceAway, seller.distanceMiles)
    : null;
      ...
      <main className="seller-profile" style={{ minHeight: "100dvh", background: "#FAFAFA" }}>
        {showLoading ? (
          ...
          >
            ...
            >
              This profile may have been removed, or there was a problem
          ...
          <>
            <div
              ...
              style={{
                position: "relative",
                height: "340px",
                background: badge === "Pro" ? "#ECFFD4" : "#E3C7FF",
                overflow: "hidden",
                marginTop: 0,
              }}
            >
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(to bottom, transparent 40%, rgba(13,1,32,0.3) 100%)",
                }}
              />
              <button
                type="button"
            ...
            >
              <div
                ...
                style={{
                  ...
                  alignItems: "flex-end",
                  gap: "24px",
                  boxShadow: "0 4px 32px rgba(16,24,40,0.08)",
                  flexWrap: "wrap",
                }}
              >
                <ProfileAvatar
                      ...
                      >
                        {visibleFavors.map((favor) => (
                          <SellerFavorCard
                            ...
                            onToggleLike={() =>
                              toggleFavorLike(String(favor.favorId))
                            }
                          />
                        ))}
                      </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      >
                        Explore best favor providers
                      </h2>
                    </div>
                    <button
                      onClick={() =>
                        router.push("/explore/search?type=sellers")
                      }
                      style={{
                        fontFamily: "Poppins,sans-serif",
                        fontWeight: 600,
                  ...
                  >
                    {recommendedFavors.map((favor) => (
                      <RecommendedFavorCard
                        ...
                        onToggleLike={() =>
                          toggleFavorLike(`rec-${favor.favorId}`)
                        }
                      />
                    ))}
                  </div>
