  ...
  return (
    <div style={{ background: '#ffffff', borderRadius: '20px', border: '1.5px solid #EAECF0', overflow: 'hidden', minWidth: 0 }}>
      <div style={{ padding: '10px 10px 0' }}>
        <div className="listing-card-media" style={{ height: '220px', borderRadius: '14px', background: '#F2F4F7' }} />
      </div>
...
export default function SellerListingCard({
  ...
  return (
    <div
      ...
      style={{ background: '#ffffff', borderRadius: '20px', border: '1.5px solid #EAECF0', cursor: id ? 'pointer' : 'default', transition: 'border-color 0.2s ease, box-shadow 0.2s ease', overflow: 'hidden', minWidth: 0, width: '100%' }}
    ...
    >
      <div style={{ position: 'relative', padding: '10px 10px 0' }}>
        <div className="listing-card-media" style={{ height: '220px', borderRadius: '14px', overflow: 'hidden', background: '#F8F0FF' }}>
      ...
      <div style={{ padding: '14px 16px 18px' }}>
        <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '16px', color: '#101828', marginBottom: '6px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{name}</h3>
