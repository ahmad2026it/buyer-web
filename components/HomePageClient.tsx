...
export default function HomePageClient({ seoSlot }: HomePageClientProps) {
  ...
  // Default to guest/marketing content for SSR and first paint so crawlers
  // receive the hero H1 and homepage copy. Switch after client mount if logged in.
  const isLoggedIn =
    mounted &&
    (Boolean(token) ||
      (typeof window !== 'undefined' &&
        localStorage.getItem('whoCan_loggedIn') === 'true'));
              ...
              <div className="container" style={{ paddingTop: 18, paddingBottom: 20 }}>
                ...
                <div className="rs-section-head home-greet" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
                  <div style={{ minWidth: 0 }}>
                    ...
                    <p style={{ fontFamily: 'Poppins,sans-serif', fontWeight: 700, fontSize: 22, color: '#101828', margin: 0, overflowWrap: 'anywhere' }}>
                      Welcome, {firstName}
                    </p>
                  </div>
